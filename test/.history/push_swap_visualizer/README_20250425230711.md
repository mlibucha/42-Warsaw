...
- If you've relocated your push_swap program, simply update the visualizer'stack menu directory from "../../push_swap" to the new path of your push_swap program. For instance, "../../new_directory/push_swap".
