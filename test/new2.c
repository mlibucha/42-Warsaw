...
//to jest parse.c zmienione z powodu tego ze jest stack co 2 staki rzechowuje bo iporostu jest to zmieniopne 
...
void fill_stack(t_stack *stack, int *tablica, int count)//ta funkcja zmieniona lekko po wcześniej byla nie poprawna
{
	int		i;
	t_node	*new;
